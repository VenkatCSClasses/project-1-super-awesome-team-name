...
Follow the installation instructions for UV on their [offical website](https://docs.astral.sh/uv/#highlights)

### Clone the Repository
Clone the repository to your local machine using the following command:
```sh
git clone https://github.com/VenkatCSClasses/project-1-super-awesome-team-name.git
```

Now navigate into the project directory and install the dependencies with the following command:
```sh
uv sync
```
